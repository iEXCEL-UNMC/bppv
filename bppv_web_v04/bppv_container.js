...
document.getElementById( 'threejs-canvas' ).width = 929;
document.getElementById( 'threejs-canvas' ).height = 695;



var CANVAS_WIDTH = document.getElementById( 'threejs-canvas' ).width;
var CANVAS_HEIGHT = document.getElementById( 'threejs-canvas' ).height;

document.getElementById( 'threejs-canvas2' ).width = 500;
document.getElementById( 'threejs-canvas2' ).height = 500;



var CANVAS_WIDTH2 = document.getElementById( 'threejs-canvas2' ).width;
var CANVAS_HEIGHT2 = document.getElementById( 'threejs-canvas2' ).height;



//var CANVAS_WIDTH = 929;
//var CANVAS_HEIGHT = 695;

let camera, camera2, scene1, scene2, renderer, renderer2, container2, controls, controls2, control;
...
function init() {
    ...
    container2 = document.getElementById( 'threejs-canvas2' );
    ...
    // ---------------------------------------------------------------------
    // Perspective Camera Scene 2
    // ---------------------------------------------------------------------
    camera2 = new THREE.PerspectiveCamera( 45, CANVAS_WIDTH2 / CANVAS_HEIGHT2, 1, 2000 );
    camera2.position.set( 0,0,300 );
    //camera.lookAt( 0,550,0);

    camera2.name = 'PerspectiveCameraScene2';
    ...
    gltfLoader.load( './three/models/human_blender_rigged.glb', function ( gltf ) {
        ...
        bppvHuman.position.set( 45,-32,-100 );
        //scene2.add(bppvHuman);
    ...
    //innerEar
    gltfLoader.load( './three/models/innerEar_left.glb', function ( gltf) {

        ear = gltf.scene;
        ear.scale.multiplyScalar( 1200 );
        ear.position.set( 320,0,0 );
        ...
        gltfLoader.load( './three/models/innerEar.glb', function ( gltf) {
            ...
            ear2 = gltf.scene;
            ear2.scale.multiplyScalar( 1200 );
            ear2.position.set( -300,0,0 );
            ...
            ear2.getObjectByName("BG_R_saccule_LP").material.transparent = true;
            ear2.getObjectByName("BG_R_saccule_LP").material.opacity = 0.5;
    
            //making canals transparent
            for(var i = 1; i <=5; i++){
            ear2.getObjectByName("BG_R_SemicircCanals_Cochlea_Bone_LP2_" + i).material.transparent = true;
            ear2.getObjectByName("BG_R_SemicircCanals_Cochlea_Bone_LP2_" + i).material.opacity = 0.3;
            }
        ...
        //innerEarOnTheSidePanel
        gltfLoader.load( './three/models/innerEar.glb', function ( gltf) {

            ear3 = gltf.scene;
            ear3.scale.multiplyScalar( 1200 );
            ear3.position.set( 0,-20,0 );
    
    
            ear3.castShadow = true;
            ear3.receiveShadow = true;
            scene2.add( ear3 );
            //scene2.add( ear2 );
            ...
            ear3.getObjectByName("BG_R_saccule_LP").material.transparent = true;
            ear3.getObjectByName("BG_R_saccule_LP").material.opacity = 0.5;
    
            //making canals transparent
            for(var i = 1; i <=5; i++){
            ear3.getObjectByName("BG_R_SemicircCanals_Cochlea_Bone_LP2_" + i).material.transparent = true;
            ear3.getObjectByName("BG_R_SemicircCanals_Cochlea_Bone_LP2_" + i).material.opacity = 0.3;
            }
...
*/
    ...
    .load('brown_photostudio_01_2k.hdr', function (texture) {
        ...
        scene1.background = new THREE.Color( "rgb(229,226,244)" );
        scene2.background = new THREE.Color( "rgb(255,255,255)" );
    ...
    renderer2 = new THREE.WebGLRenderer( { antialias: true, canvas: container2} );
    renderer2.setPixelRatio( window.devicePixelRatio );
    renderer2.setSize( CANVAS_WIDTH2, CANVAS_HEIGHT2, false );
...
///////////////////////////////////////////////////////////////
    ...
    //toggle to keep track of text labels
    ...
    document.getElementById ("hideControlsButton" ).addEventListener( "click", function () {
        ...
        if(toggle == false) {
            ...
            document.getElementById ("hideControlsButton" ).text = "Hide Controls";
            toggle = true;
        }

        else {
    
            document.getElementById ("hideControlsButton" ).text = "Show Controls";
            toggle = false;
        }
...
function animate() {
    ...
    if(ear && character){
        ...
        ear2.rotation.x = characterHead.rotation.x;
        ear2.rotation.y = characterHead.rotation.y;
        ear2.rotation.z = characterHead.rotation.z;

        ear3.rotation.x = characterHead.rotation.x;
        ear3.rotation.y = characterHead.rotation.y;
        ear3.rotation.z = characterHead.rotation.z;
